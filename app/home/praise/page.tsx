...
export default function Praise() {
    ...
    useEffect(() => {
        axios.get('http://localhost:8000/emp/allemp').then((response) => {
                ...
                <div className="">
                                    ...
                                    <DialogDescription className='flex flex-col gap-2 min-h-auto max-h-80 overflow-y-auto'>
                                        {
                                            emp.map((src, index) => {
                                                ...
                                                return (
                                                    ...
                                                    >
                                                        <img src={'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS6dD4uBABfvtxIdgJz3ZupQ1_rAdTo606MhA&s'} alt={name} width={40} />
                            ...
                            {employee.map((src, index) => (
                                <div className="truncate" key={index}>
                                    <ProfileAvatar
                                        ...
                                        url={'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS6dD4uBABfvtxIdgJz3ZupQ1_rAdTo606MhA&s'}
                                        key={index}
                    ...
                    <div className="overflow-y-auto sm:p-1 w-full">
                        ...
                        <p className='p-2'>Praise Point</p>
                            <input type="number" className='p-2 w-20 border rounded-lg' value={praisePts} placeholder='points' onChange={(e)=>setPraisePts(Number(e.target.value))} min={0} max={1000} width={10}/>
                        </div>
                        <div className="flex gap-4 flex-wrap overflow-y-auto p-1 max-h-[8dvh]">
                            {award.map((src, index) => (
                                <div className="truncate" key={index}>
