          ...
          emp.map((emp, idx) => {
            return (
              <span className="border rounded-md inline-block m-1 cursor-pointer" key={idx}>
                <ProfileCard key={idx} name={emp.first_name + " "+emp.last_name} title={emp.post} imageUrl={'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS6dD4uBABfvtxIdgJz3ZupQ1_rAdTo606MhA&s'} level={emp.location}/>
              </span>
            )
          })
        }
