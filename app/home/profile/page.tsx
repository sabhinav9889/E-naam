...
import { historyData, dateData, userName, post, company, email, location, dob, mobile } from "@/app/constants/constant";
  ...
  return (
    ...
    <div className="w-full  h-[70dvh] p-4 pt-12">
      ...
      <div className="flex sm:gap-4 gap-2">
        <Profile userName={userName} post={post} company={company} email={email} location={location} dob={dob} mobile={mobile} />
