  ...
  return (
    ...
    >
      <span className="flex p-4">
        ...
        <span className="p-4 font-bold text-2xl">E-naam</span>
      </span>
    </div>
  );
}
...
function SidebarFooter({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      {...props}
    >
      <span className="p-2 text-sm flex hover:text-slate-500 cursor-pointer absolute bottom-0 ">
        <span className="p-2">
          <LogOut />
        </span>
...
function SidebarGroup({ className, ...props }: React.ComponentProps<'div'>) {
  const dashboard = ['Dashboard', 'Projects', 'Employees', 'Praise'];
  const icons = [
    <LayoutDashboard key="dashboard" />,
    <Folders key="folders" />,
    <Users key="users" />,
    <Award key="award" />,
  ];
